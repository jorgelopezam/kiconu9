...
export function ImageUploadDialog({ isOpen, onClose, sectionId, courseId, onSuccess }: ImageUploadDialogProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const storageRef = ref(storage, `courses/images/${courseId}/${fileName}`);
            ...
            await new Promise<string>((resolve, reject) => {
                ...
                setStatus("Guardando...");
                await createCourseItem(sectionId, courseId, title.trim(), "image", fileUrl);
                handleClose();
                onSuccess();
            });
        } catch (error) {
