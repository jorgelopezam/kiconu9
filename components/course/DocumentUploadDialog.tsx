...
export function DocumentUploadDialog({ isOpen, onClose, sectionId, courseId, onSuccess }: DocumentUploadDialogProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const storageRef = ref(storage, `courses/documents/${courseId}/${fileName}`);
            ...
            await new Promise<string>((resolve, reject) => {
                ...
                setStatus("Guardando...");
                await createCourseItem(sectionId, courseId, title.trim(), "document", fileUrl);
                handleClose();
                onSuccess();
            });
        } catch (error) {
