...
export default function MarketingPage() {
  ...
  const fetchCoupons = useCallback(async () => {
    ...
    try {
      ...
      const newUserCache = new Map(userCacheRef.current);
          ...
          <div className="pb-3">
            <div className="flex gap-4 overflow-x-auto border-b border-panel-border sm:gap-8">
              <button
                ...
                className={`flex flex-col items-center justify-center whitespace-nowrap border-b-[3px] pb-[13px] pt-4 transition-colors ${activeTab === "branding"
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center whitespace-nowrap border-b-[3px] pb-[13px] pt-4 transition-colors ${activeTab === "promociones"
                    ? "border-b-panel-primary text-panel-text"
                    : "border-b-transparent text-panel-muted"
                  }`}
              >
