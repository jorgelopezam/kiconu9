...
function Payment2PageContent() {
  ...
  return (
    <div className="min-h-screen py-8 lg:py-12">
      <main className="mx-auto max-w-2xl px-4 sm:px-10 flex flex-col items-center">
        <div className="h-fit w-full rounded-xl border border-panel-border bg-panel-card p-8">
          <h2 className="mb-6 text-2xl font-bold text-panel-text">Completa tu Pago</h2>
